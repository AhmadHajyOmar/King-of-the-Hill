...
public class SimpleImpationCaseTest1 {
    ...
    public void setFoodPheromone(Trail t, Pheromone value) {
        try {
    ...
    void run() {
        ...
        inOrder.verify(recorder).select(eq(ant), same(trail1), eq(List.of(trail1)), same(Recorder.SelectionReason.EXPLORATION));
    }
}
