...
public class LowestPheromoneChoiceTest {
    ...
    void setUp() {
        ...
        setFoodPheromone(trail1, com.pseuco.np21.shared.Trail.Pheromone.get(1));
    ...
    void run() {
        ...
        inOrder.verify(recorder).select(eq(ant), same(trail1), eq(List.of(trail1)), same(Recorder.SelectionReason.FOOD_SEARCH));
    }
}